...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.imgSampleOne -> {
                setViewAndDetect(getSampleImage(R.drawable.box1_mini))
            }
            R.id.imgSampleTwo -> {
                setViewAndDetect(getSampleImage(R.drawable.box2_mini))
            }
            R.id.imgSampleThree -> {
                setViewAndDetect(getSampleImage(R.drawable.box3_mini))
            }
        }
    }
